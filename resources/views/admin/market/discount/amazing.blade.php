...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page">فروش فوق العاده</li>
        </ol>
    </nav>
        ...
        <section class="col-12">
            <section class="main-body-container">
             ...
             فروش شگفت انگیز
                    ...
                    <p>
             از این بخش میتوانید کالا مورد نظر را انتخاب و به لیست فروش شگفت انگیز اضافه کنید
                    </p>
                </section>
                <section class="d-flex justify-content-between align-items-center mt-5 mb-5  border-bottom  py-2">
                    <a href=" {{ route('admin.market.discount.amazingSale.create') }}" class="btn btn-info  btn-sm">افزودن</a>
                    <div class="w-16rem">
